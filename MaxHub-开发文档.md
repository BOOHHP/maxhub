...
| 1.1.0 | 界面大改版：左侧改宽文字导航（圆角高亮块）、内容区子 tab 改下划线式、对齐深色高级感视觉（近黑分层 + 浅蓝主按钮） |
...
当前生产版本：**1.5.13**，兼容 Max 2019–2026。
...
- Agent 1.1.0 SHA-256：`bc7aa14f02cf928d7908db3e9d867ca94fd3152a6d3cd9583d6ce872db9489e7`。
