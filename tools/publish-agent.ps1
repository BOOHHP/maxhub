...
Write-Host ""
Write-Host "Next: upload $distPath to GitHub Release, then set in appsettings.Local.json:"
Write-Host "  Agent:LatestVersion = $version"
Write-Host "  Agent:DownloadUrl   = https://github.com/<owner>/<repo>/releases/download/v$version/MaxHubAgent-$version-win-x64.exe"
